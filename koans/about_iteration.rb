...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject either starts with the first element or what you pass it,
    # does some stuff and returns the result of each block and then
    # passes the result as the first parameter on the next block
